...
1. A class that returns a decoded file as an object
2. The name of the file being accessed
3. The mode of the file, currently set to read only
4. Unicode Transformation Format - 8-Bit, represents the encoding for the webpage file (how it is stored) 
-------------------------------------------------''')
# What does the following parts of the file handle mean?
# 1) _io.TextIOWrapper 
