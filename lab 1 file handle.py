...
-------------------------------------------------
# What does the following parts of the file handle mean?
# 1) _io.TextIOWrapper is the class used to open the file
# 2) name='text-file-matrix.txt' is the name of the file being opened
# 3) mode='r' is how the file is being processed, in this case it is being read
# 4) encoding='UTF-8'> is how the file is encoded, in this case it is encoded in 8 bit values
# -----------------------------
-------------------------------------------------''')
